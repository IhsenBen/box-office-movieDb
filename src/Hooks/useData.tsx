...
const topRatedMovies = movies.sort((a: any, b: any) => b.vote_average - a.vote_average);
// Slice 10 movies from topRatedMovies for the slider
const sliderMovies = topRatedMovies.filter((movie: any) => movie.vote_average >= 7).slice(0, 10);
// Slice the Rest of topRatedMovies for the cards
const cardMovies = topRatedMovies.filter((movie: any) => !sliderMovies.includes(movie)).sort((a: any, b: any) => b.vote_average - a.vote_average);

return { topRatedMovies, sliderMovies, cardMovies};
